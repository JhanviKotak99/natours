(() => {
  ...
  var displayMap = (locations) => {
    mapboxgl.accessToken = "pk.eyJ1IjoiamhhbnZpdGciLCJhIjoiY2xyamdjeGo4MDNlNzJrazBiZHM3NzFodSJ9.WUqfDc-h_fJOf6X71-XjVA";
  ...
  var userPasswordForm = document.querySelector(".form-user-password-update");
